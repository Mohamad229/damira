...
import { sanitizeTemplateValue } from "@/lib/content/admin-template-sanitizer";
...
export default async function EditPagePage({
  ...
  const publicUiData = getPublicUiData(locale);
  const cleanPageData = publicUiData[id as keyof PublicUiData] as unknown as
